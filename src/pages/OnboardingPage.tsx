...
export function OnboardingPage() {
  ...
  return (
    <main className="onboarding-page"><section className="onboarding-card"><div className="onboarding-top"><BrandIdentity context="Configuração inicial" /><span className="step-counter">{progress}</span></div><div className="progress-track"><span style={{ width: `${step * 25}%` }} /></div>
