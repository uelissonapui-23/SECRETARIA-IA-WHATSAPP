...
function WorkRow({title,detail,due,priority,kind,contact,amount,status,onComplete,onPostpone,onPrioritize,onEdit,onDelete}:{title:string,detail?:string|null,due?:string|null,priority:string,kind:string,contact?:string|null,amount?:string|null,status:string,onComplete:()=>void,onPostpone:()=>void,onPrioritize:()=>void,onEdit:()=>void,onDelete:()=>void}){
